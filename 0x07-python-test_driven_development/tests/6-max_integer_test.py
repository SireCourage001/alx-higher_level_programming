#!/usr/bin/python3
"""Module for 6-max_integer_test

This module contains unit_test for the function ``max_integer``
"""
import unittest
...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_integers(self):
        """Tests when valid integers are in list"""
    ...
    def test_max_integer(self):
        """Test with lists containing  maximum integer"""
    ...
    def test_no_arg(self):
        """Tests when function is passed no argument"""
        self.assertEqual(max_integer(), None)

    def test_empty(self):
        """Tests for when an empty list is passed to function"""
