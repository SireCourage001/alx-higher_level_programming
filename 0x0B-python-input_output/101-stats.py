...
def print_info(total_file_size, stat_codes_occurence):
    """Prints info gathered thus far from the log

    Args:
        total_file_size (int): Total size of files read so far
        stat_codes_occurence (dict): Key/value pairs of all the status codes
            and number of occurences in the ten line window
    """
