...
/**
 * print_python_float - Func to print details on Python float object.
 * @p: A Python object.
 */
...
/**
 * print_python_bytes - Func to print details on Python byte object.
...
/**
 * print_python_list - C func to print information on a Python List object.
 * @p: A python object.
 */
