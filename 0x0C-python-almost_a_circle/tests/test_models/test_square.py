#!/usr/bin/python3
"""Tests for Square class in the square module.
Square module is in the models' package"""
...
class TestSquare(unittest.TestCase):
	...
	"""Test if class inherits from its base class."""
	...
	"""Test getter/setter methods for private instance attributes."""
	sq1 = Square(1, 2, 3, 4)
	sq2 = Square(5, 6)
	...
	"""Test types and values of all attributes with error messages."""
