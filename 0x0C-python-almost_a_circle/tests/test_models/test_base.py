#!/usr/bin/python3
"""A test module for Base class in the models package"""
...
class TestBase(unittest.TestCase):
	...
	def setUp(self):
	"""Method to run at the beginning of each test method"""
	Base._Base__nb_objects = 0

	def test_id(self):
	"""Check if id attribute is correct."""
	...
	def test_inheritance(self):
		"""A Test Square and Rectangle inheritance from parent Base"""
		base1 = Base()
		rect1 = rectangle(1, 2)
		rect2 = Rectangle(1, 2)
	...
	def test_to_json_string(self):
		"""A Test for method "t0_json_string" with expected input"""
	...
	def test_to_json_string_2(self):
		"""Test with invalid num of rguments."""
	...
	def test_save_to_file(self):
		"""Test method save_to_file wit expected input."""
	...
	def test_save_to_file_1(self):
		"""Test with wrong num of arguments."""
